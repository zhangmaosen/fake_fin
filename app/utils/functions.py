...
async def run_model(system_prompt, full_text, model_select, user_prompt,  temperature=0.1, num_ctx=30000, num_predict=250, keep_alive=-1, local_or_online='local', key=None, stream=False):
